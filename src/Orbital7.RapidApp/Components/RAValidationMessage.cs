...
public class RAValidationMessage<TValue> : ComponentBase, IDisposable
{
    ...
    protected override void OnParametersSet()
    {
        ...
        else if (For != _previousFieldAccessor && RAFormInput != null)
        {
            ...
            if (RAChildInputValidationFacilitatorForToString.HasText())
            {
    ...
    private string ParseRAFieldName()
    {
        ...
        if (For != null)
        {
            var expressionToString = For.ToString();
    ...
    {
        var frags = RAChildInputValidationFacilitatorForToString.Parse(".");
        return frags.Last();
    }
