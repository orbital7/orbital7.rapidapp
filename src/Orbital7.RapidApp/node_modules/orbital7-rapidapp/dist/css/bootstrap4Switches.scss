/* Source: https://www.abeautifulsite.net/bootstrap-4-switches */
...
$switch-checked-bg: $ra-color-actor-selectable !default; /*map-get($theme-colors, 'primary') !default;*/
$switch-disabled-bg: $custom-control-indicator-disabled-bg !default;
$switch-disabled-color: #868e96 !default; /*$custom-control-description-disabled-color*/
$switch-thumb-bg: $white !default;
$switch-thumb-border-radius: 50% !default;
$switch-thumb-padding: 2px !default;
$switch-focus-box-shadow: 0 0 0 $input-btn-focus-width rgba($ra-color-actor-selectable, .25); /*0 0 0 $input-btn-focus-width rgba(map-get($theme-colors, 'primary'), .25);*/
