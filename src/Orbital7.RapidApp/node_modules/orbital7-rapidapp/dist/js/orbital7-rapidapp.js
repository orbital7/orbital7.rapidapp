...
function raShowModalDialog(contentUrl, returnAction, dialogTitle,
...
function raSetResumeValue(area, type, id, value) {

    localStorage.setItem(area + "*" + type + "|" + id, value);
}

function raSetResumeField(area, type, fieldSelector, isCheckbox) {

    var field = $(fieldSelector);
    if (!isCheckbox) {
        raSetResumeValue(area, type, fieldSelector, field.val());
    }
    else {
        raSetResumeValue(area, type, fieldSelector, field.prop("checked"));
    }
}
